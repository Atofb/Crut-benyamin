...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mb-4">Edit Data Umat Gereja</h1>
              ...
              <div class="card">
                <div class="card-body">
                  <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Asal Lingkungan</label>
                      <input type="text"  name="lingkungan" class="form-control" id="exampleInputEmail1"
                       aria-describedby="emailHelp" value="{{ $data->lingkungan }}">
                    </div>
                    <div class="mb-3">
